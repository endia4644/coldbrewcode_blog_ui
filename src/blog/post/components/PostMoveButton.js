  ...
  return (
    <>
      <Button
        ...
        className={direction === 'left' ? 'post-button post-left-button' : 'post-button post-right-button'}
        onClick={(e) => onClick(e, post.id)}
      >
        <Space direction="vertical" className={direction === 'left' ? 'post-left' : 'post-right'}>
          <Typography.Text>{direction === 'left' ? '이전' : '다음'} 포스트</Typography.Text>
