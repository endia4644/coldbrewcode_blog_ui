...
export default function Post({ posts, isUpdate }) {
  ...
  return (
    <>
      ...
      {isUpdate && list &&
        <div className="ant-list ant-list-vertical ant-list-lg ant-list-split series-post">
          <div className="ant-spin-nested-loading">
            <div className="ant-spin-container">
              <ul className="ant-list-items">
                ...
                >
                  {list.map((item) => (
                    <li className="ant-list-item" style={{ paddingTop: 30 }} key={`post_${item.id}`}
                    >
                      <div className="ant-list-item-main">
                        <Typography.Title>
                          <Link to={`/blog/post/${item.id}?postType=series`}>{item.postName}</Link>
                        </Typography.Title>
                        <div className="ant-list-item-meta"></div>
                        <Typography.Paragraph
                          style={{ minHeight: 66 }}
                          ellipsis={{
                            rows: 3,
